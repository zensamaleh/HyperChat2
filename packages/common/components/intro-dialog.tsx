...
export const IntroDialog = () => {
    ...
    const points = [
        ...
        {
            icon,
            text: `**Extension des Agents** : L'intégration de nouveaux agents est prévue pour couvrir un éventail encore plus large de vos besoins opérationnels. (Bientôt disponible)`,
        },
        {
            icon,
            text: `**Suivi d'Utilisation des Agents** : Une fonctionnalité dédiée vous permettra de surveiller et d'analyser en temps réel l'activité et la performance de vos agents. (Bientôt disponible)`,
        },
    ];
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        >
                            ...
                            <p className="font-clash text-foreground text-lg font-bold tracking-wide">
                                hyperfixx-chat.vercel.app
                            </p>
                        </div>
                        <p className="text-base font-semibold">
                            Solution d'Agents IA sur Mesure pour Hyper

Développée par Samaleh Mohamed Hassan et personnalisée pour l'entreprise Hyper, cette suite d'agents intelligents est conçue pour optimiser et automatiser vos processus clés.
                        </p>
                    </div>

                    <div className="flex flex-col gap-2">
                        <h3 className="text-sm font-semibold">Nos Agents Actuels et Leurs Fonctions :</h3>
